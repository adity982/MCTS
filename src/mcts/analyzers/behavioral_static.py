...
_SINK_MARKERS = {
    ...
    "process.env": Severity.HIGH,
    "gzipSync": Severity.HIGH,
    "express.listen": Severity.HIGH,
    "axios": Severity.MEDIUM,
    "httpx": Severity.HIGH,
    "follow_redirects": Severity.HIGH,
    "AsyncClient": Severity.HIGH,
    "http_client": Severity.HIGH,
    "fs": Severity.MEDIUM,
